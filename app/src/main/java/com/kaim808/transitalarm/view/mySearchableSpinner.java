...
public class mySearchableSpinner extends Spinner implements View.OnTouchListener,
    ...
    public void setTouchViewTriggerAndGetTextViewToBeUpdated(ImageView v, TextView view){
        v.setOnTouchListener(this);
        textViewToBeUpdated = view;
    ...
    public mySearchableSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void onSearchableItemClicked(Object item, int position) {
        textViewToBeUpdated.setText(item.toString());
